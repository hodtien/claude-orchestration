...
const MODEL = process.env.GEMINI_MODEL ?? "gemini-3.1-pro-preview"; // quota group 2 — security/threat model tasks
...
---COMPRESSED-CONTEXT---
[2-5 sentence summary of the key security findings or decisions that a downstream agent would need]
